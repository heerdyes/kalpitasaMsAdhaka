public class RAM65536x8{
  ...
  void feed(boolean a15,boolean a14,boolean a13,boolean a12,boolean a11,boolean a10,boolean a9,boolean a8,boolean a7,boolean a6,boolean a5,boolean a4,boolean a3,boolean a2,boolean a1,boolean a0,
    ...
    // selection
    s7.feed(a15,a14,a13,r0.do7,r1.do7,r2.do7,r3.do7,r4.do7,r5.do7,r6.do7,r7.do7);
    s6.feed(a15,a14,a13,r0.do6,r1.do6,r2.do6,r3.do6,r4.do6,r5.do6,r6.do6,r7.do6);
    s5.feed(a15,a14,a13,r0.do5,r1.do5,r2.do5,r3.do5,r4.do5,r5.do5,r6.do5,r7.do5);
    s4.feed(a15,a14,a13,r0.do4,r1.do4,r2.do4,r3.do4,r4.do4,r5.do4,r6.do4,r7.do4);
    s3.feed(a15,a14,a13,r0.do3,r1.do3,r2.do3,r3.do3,r4.do3,r5.do3,r6.do3,r7.do3);
    s2.feed(a15,a14,a13,r0.do2,r1.do2,r2.do2,r3.do2,r4.do2,r5.do2,r6.do2,r7.do2);
    s1.feed(a15,a14,a13,r0.do1,r1.do1,r2.do1,r3.do1,r4.do1,r5.do1,r6.do1,r7.do1);
    s0.feed(a15,a14,a13,r0.do0,r1.do0,r2.do0,r3.do0,r4.do0,r5.do0,r6.do0,r7.do0);
    do7=s7.q;
    do6=s6.q;
    do5=s5.q;
    do4=s4.q;
