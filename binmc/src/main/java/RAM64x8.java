public class RAM64x8{
  ...
  void feed(boolean a5,boolean a4,boolean a3,boolean a2,boolean a1,boolean a0,
    ...
    // selections
    s7.feed(a5,a4,r0.do7,r1.do7,r2.do7,r3.do7);
    s6.feed(a5,a4,r0.do6,r1.do6,r2.do6,r3.do6);
    s5.feed(a5,a4,r0.do5,r1.do5,r2.do5,r3.do5);
    s4.feed(a5,a4,r0.do4,r1.do4,r2.do4,r3.do4);
    s3.feed(a5,a4,r0.do3,r1.do3,r2.do3,r3.do3);
    s2.feed(a5,a4,r0.do2,r1.do2,r2.do2,r3.do2);
    s1.feed(a5,a4,r0.do1,r1.do1,r2.do1,r3.do1);
    s0.feed(a5,a4,r0.do0,r1.do0,r2.do0,r3.do0);
    do7=s7.q;
    do6=s6.q;
    do5=s5.q;
    do4=s4.q;
